...
void create()
{
	...
	_info.push_back(OptionInfo("StereoSound", &StereoSound, false));
	...
	_info.push_back(OptionInfo("useOpenGLSmoothing", &useOpenGLSmoothing, false));
...
#endif
	_info.push_back(OptionInfo("playIntro", &playIntro, false, "STR_PLAYINTRO", "STR_GENERAL"));
	...
	_info.push_back(OptionInfo("lazyLoadResources", &lazyLoadResources, false, "STR_LAZY_LOADING", "STR_GENERAL"));
...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("keyGeoDown", &keyGeoDown, SDLK_LALT, "STR_ROTATE_DOWN", "STR_GEOSCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleLeft", &keyBattleLeft, SDLK_p, "STR_SCROLL_LEFT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleRight", &keyBattleRight, SDLK_p, "STR_SCROLL_RIGHT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleUp", &keyBattleUp, SDLK_p, "STR_SCROLL_UP", "STR_BATTLESCAPE"));
	...
	_info.push_back(OptionInfo("keyBasescapeSoldiers", &keyBasescapeSoldiers, SDLK_p, "STR_SOLDIERS_UC", "STR_OXCE"));
...
#else
	_info.push_back(OptionInfo("FPS", &FPS, 30, "STR_FPS_LIMIT", "STR_GENERAL"));
	_info.push_back(OptionInfo("FPSInactive", &FPSInactive, 30, "STR_FPS_INACTIVE_LIMIT", "STR_GENERAL"));
	_info.push_back(OptionInfo("vSyncForOpenGL", &vSyncForOpenGL, false, "STR_VSYNC_FOR_OPENGL", "STR_GENERAL"));
#endif
